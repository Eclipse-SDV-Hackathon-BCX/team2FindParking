    ...
    def tick(self):
        ...
        for sumo_actor_id in sumo_spawned_actors:
            ...
            if carla_blueprint is not None:
                ...
                if (sumo_actor_id == 'parked1.0'):
                    print("Ego is injected")
                    # self.carla.world.get_spectator().set_transform(carla_transform)
                    print (carla_actor_id)
                    print (carla_transform)
                    print ("parking --------")
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--carla-host',
                           metavar='H',
                           default='ec2-18-192-45-230.eu-central-1.compute.amazonaws.com',
